...
fn build_theme(p: &Palette) -> ThemeColors {
    ThemeColors {
        ...
        text_muted: gray(p.text_muted.0, p.text_muted.1),
        ...
        border_subtle: gray(p.border_subtle.0, p.border_subtle.1),
        ...
        row_highlight: gray(p.row_highlight.0, p.row_highlight.1),
